...
Once the neutron capture spectrum has been measured, there are a number of ways it can be used to apply a correction factor to the IBD rate. We name and define these approaches as follows:
