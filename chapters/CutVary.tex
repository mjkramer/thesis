...
% plot_unc_all("fine_toymc@bcw@@redo", is_data=False, vmax=[3.55e-3, 0.94e-4])
\begin{figure}[ht]
  \begin{minipage}{0.5\linewidth}%
...
% plot_unc_all("super_shower_grid@bcw@@redo", is_data=True, vmax=[3.725e-3, 1.01e-4])
\begin{figure}[ht]
  \begin{minipage}{0.5\linewidth}%
...
% from plot_super import *
% plot_scatter_both("super_test100@bcw@@redo")
\begin{figure}[h]
