...
\begin{figure}[h]
  ...
  \caption{Histograms of random cut values used in the joint variation study. The shower-muon threshold (in PE) is in the top left, the shower-muon veto time (in seconds) is in the top right, the minimum delayed energy (in MeV) is shown in the bottom left, and the minimum prompt energy (in MeV) is shown in the bottom right. XXX move these labels to the plots!}
...
\begin{figure}[ht]
  ...
  \end{minipage}%
  \caption{Histograms of oscillation fit results under joint variations of the cuts. $\SinSq$ is on the left, and $\Dmsqee$ is on the right.}
  \label{fig:cutVaryJointVaryResults}
\end{figure}

\begin{figure}[h]
  \includegraphics[scale=0.5]{CutVary/JointVary/s2t_best_scatter.png}
  \caption{Best-fit $\SinSq$ (top panel) versus cut parameters (bottom four panels). The horizontal axis runs over the sets of random cut parameters.}
  \label{fig:cutVaryJointVaryS2tScatter}
\end{figure}

\begin{figure}[h]
  \includegraphics[scale=0.5]{CutVary/JointVary/dm2_best_scatter.png}
  \caption{Best-fit $\Dmsqee$ (top panel) versus cut parameters (bottom four panels). The horizontal axis runs over the sets of random cut parameters.}
