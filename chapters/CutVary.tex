...
% from plot_fit_results import *
% plot_all("fine_toymc@bcw@@redo", is_data=False, offset_decimals=[1, 3])
\begin{figure}[ht]
  \begin{minipage}{0.5\linewidth}%
...
% from plot_fit_results import *
% plot_all("super_shower_grid@bcw@@redo", is_data=True)
\begin{figure}[ht]
  \begin{minipage}{0.5\linewidth}%
    \includegraphics[width=\linewidth]{CutVary/ShowerVeto/s2t_best.pdf}%
  \end{minipage}%
  \begin{minipage}{0.5\linewidth}%
    \includegraphics[width=\linewidth]{CutVary/ShowerVeto/dm2_best.pdf}%
  \end{minipage}%
...
% from plot_fit_results import *
% plot_unc_all("fine_toymc@bcw@@redo", is_data=False)
% plot_unc_all("fine_toymc@bcw@@redo", is_data=False, vmax=[2.79e-3, 6.62e-4])
\begin{figure}[ht]
  \begin{minipage}{0.5\linewidth}%
...
% from plot_fit_results import *
% plot_unc_all("super_shower_grid@bcw@@redo", is_data=True)
% plot_unc_all("super_shower_grid@bcw@@redo", is_data=True, vmax=[2.95-3, 7.1e-4])
\begin{figure}[ht]
  \begin{minipage}{0.5\linewidth}%
...
% from plot_fit_results import *
% plot_fit_all("delcut_fourth_toymc@bcw@@redo")
\begin{figure}[ht]
  \begin{minipage}{0.5\linewidth}%
...
% plot_input(["delcut_fourth@bcw@rel@new@@redo"], "acc_bkg", "acc_bkg_unc")
\begin{figure}[ht]
...
\begin{figure}[ht]
  \begin{minipage}{0.5\linewidth}%
    \includegraphics[width=\linewidth]{CutVary/DelayedCut/s2t_best_bincomp.pdf}%
  \end{minipage}%
  \begin{minipage}{0.5\linewidth}%
    \includegraphics[width=\linewidth]{CutVary/DelayedCut/dm2_best_bincomp.pdf}%
  \end{minipage}%
  \caption{Comparison of delayed-energy cut variation (when fitting P17B data) between LBNL and BCW binning. The offset in $\Dmqee$ between the two binnings is a known consequence of unresolved biases in the modeling of the low-energy response of the ADs (\autoref{sig:fitBinning}). The BCW binning, which we employ, uses coarser bins, particularly at low energies, and is therefore less sensitive to these biases.}
...
% (by optimizing the balance between statistics and the IAV uncertainty)
...
% from plot_fit_results import *
% plot_fit_all("procut_first@bcw@@redo")
\begin{figure}[ht]
  \begin{minipage}{0.47\linewidth}%
    \includegraphics[width=\linewidth]{CutVary/PromptCut/s2t_best.pdf}%
  \end{minipage}%
  \begin{minipage}{0.47\linewidth}%
    \includegraphics[width=\linewidth]{CutVary/PromptCut/dm2_best.pdf}%
  \end{minipage}%
...
% from plot_fit_results import *
% plot_fit_unc_all("procut_first@bcw@@redo")
\begin{figure}[ht]
  \begin{minipage}{0.47\linewidth}%
...
% plot_labeled_fits_all("test_newVtxEff2@bcw@@redo_cleanLabels", suffix=" vs. vertex cut", xlabel="Vertex cut")
\begin{figure}[ht]
  \begin{minipage}{0.47\linewidth}%
    \includegraphics[width=\linewidth]{CutVary/VertexCut/s2t_best_labeled.pdf}%
  \end{minipage}%
  \begin{minipage}{0.47\linewidth}%
    \includegraphics[width=\linewidth]{CutVary/VertexCut/dm2_best_labeled.pdf}%
  \end{minipage}%
...
\begin{figure}[ht]
  \begin{minipage}{0.47\linewidth}%
    \includegraphics[width=\linewidth]{CutVary/VertexCut/s2t_best.pdf}%
  \end{minipage}%
  \begin{minipage}{0.47\linewidth}%
    \includegraphics[width=\linewidth]{CutVary/VertexCut/dm2_best.pdf}%
  \end{minipage}%
...
% plot_cut_hists("super_test100@bcw@@redo")
\begin{figure}[h]
  \begin{minipage}{0.5\linewidth}%
...
% from plot_super import *
% plot_qty_hists("super_test100@bcw@@redo")
\begin{figure}[ht]
  \begin{minipage}{0.5\linewidth}%
    \includegraphics[width=\linewidth]{CutVary/JointVary/s2t_best.pdf}%
  \end{minipage}%
  \begin{minipage}{0.5\linewidth}%
    \includegraphics[width=\linewidth]{CutVary/JointVary/dm2_best.pdf}%
  \end{minipage}%
...
% from plot_super import *
% plot_scatter_both_all("super_test100@bcw@@redo")
\begin{figure}[h]
  \includegraphics[scale=0.5]{CutVary/JointVary/scatter_both_best.pdf}
