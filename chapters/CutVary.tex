...
\begin{figure}[h]
  ...
  \end{minipage}%
  \caption{Marginal histograms of the 100 random cuts used in the joint variation study. Each cut (consisting of four parameters sampled from uncorrelated truncated-Gaussian distributions) is represent once in each of these histograms.}
