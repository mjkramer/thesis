...
Mueller \emph{et al.} provide correction factors for \urfive, \punine, and \puone in five energy bins from 2 to 4~MeV, calculated at irradiation times of 100~d, 10$^7$~s ($\sim$115~d), 300~d, and 450~d. The ILL reference spectra provide an anchor at 36~h (except for \urfive, which was measured at 12~h; a 36~h correction is thus provided by the authors). These corrections, at 450~d, are at most 2\% (5\% for \urfive). They also account another, subdominant difference between the reactor environment and the ILL apparatus, namely, the presence of epithermal and fast neutrons, altering the distribution of fission fractions.
