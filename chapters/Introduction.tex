...
\emph{disappearance} of (anti)\-neu\-trinos of a given flavor, our interest is
in \(P(\alpha \rightarrow \alpha)\). In this case, the behavior of neutrinos and
antineutrinos is the same, and \eqref{eq:oscReIm} simplifies to
\begin{equation*}
  P(\alpha \rightarrow \alpha) = 1 - 4 \sum_{j>i} |U_{\alpha j}|^2 |U_{\alpha
    i}|^2 \sin^2\left( \frac{\Delta m^2_{ji} L}{4E} \right). 
\end{equation*}
The matrix elements from \eqref{eq:upmnsParam} can then be inserted in order to
