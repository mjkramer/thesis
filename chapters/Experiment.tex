...
\begin{figure}[ht]
  ...
  \caption{An illustration of the inverse beta decay reaction. Unlike a water Cerenkov detector, a Daya Bay AD cannot discern the direction of the positron. From \cite{OliviaPoster}.}
  \label{fig:expIBD}
\end{figure}
