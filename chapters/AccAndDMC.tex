...
TODO: Describe generalization to case where different time periods and/or energy ranges are used before/after the event. Hint: Take the two coupled equations, move all exponentials to the left side, add the two equations.
