...
For each bin $i$ of the singles' energy histogram, with measured count $N_i$, let $N'_i$ denote corresponding the random variable describing a hypothetical ensemble of experiments.
