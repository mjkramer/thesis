...
\begin{figure}[h]
  \includegraphics[scale=0.5]{Selection/veto_diagram_rM.png}
  \caption{Illustration of the muon veto scheme.}
...
\begin{figure}[h]
  \includegraphics[scale=0.5]{Selection/dmc_diagram_rM.png}
  \caption{Illustration of the decoupled multipicity cut.}
