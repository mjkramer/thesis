...
\begin{equation*}
  F_{kj,i}(\Enu; \Erec) = e_{kj,i}(\Enu) \times N_{ij}(\Enu)
\end{equation*}
...
\begin{equation*}
  F_{ki}(\Erec) = \sum_j \sum_{\Enu} F_{kj,i}(\Enu; \Erec)
\end{equation*}
...
\subsubsection{Combination of near site data}

\begin{comment}
Data is summed across all ADs in each near site.
\end{comment}

\subsubsection{Combination of far site predictions}

\begin{comment}
The far site prediction is summed across the four far ADs.
\end{comment}

\subsubsection{Combination of far site data}

\begin{comment}
The far site data is summed across the four far ADs.
\end{comment}

\subsubsection{Combination of covariance matrix}

\begin{comment}
See CombineMatrix in Predictor.cc.
\end{comment}

\subsubsection{Dealing with 6/8/7AD periods}
