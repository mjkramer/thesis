...
\end{equation}
where $i$ and $j$ are bin indices, and $\Miav$ is subject to the normalization condition $\sum_i\Miav_{ij} = 1$ for all true energy bins $j$ (i.e., the conversion preserves the total neutrino count, as it should). Each axis of $M^{\mathrm{IAV}}$ contains 240 bins of width 50~keV ranging from 0 to 12~MeV.
