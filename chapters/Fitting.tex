...
\begin{enumerate}
\item The detector response matrix $\Miav$ \autoref{eq:Miav} is used to generate a distribution of $\Enu$, by taking the row corresponding to the $\Erec$ bin being extrapolated.
