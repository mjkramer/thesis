...
The cross section $\sigma(E_\nu)$ is calculated by performing a $4\pi$ numerical integration of the differential cross section (to first order in the inverse nucleon mass $1/M$) \cite{Vogel_1999},
\begin{equation}
  \label{eq:ibdXsec}
