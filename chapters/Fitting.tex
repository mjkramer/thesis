...
XXX discuss how multiple data periods are handled, especially correlation of systematics (e.g. Table 5 in 9999).
...
\begin{itemize}
\item The covariance matrices for signal and background systematics, used in calculating $\chi^2$ during the fit.
